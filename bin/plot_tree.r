#
# functions for plotting a tree (this script is distributed with the treemix package) and therefore, not developed by us. 
#
...
plot_tree_internal = function(d, e, o = NA, cex = 1, disp = 0.005, plus = 0.005, arrow = 0.05, ybar = 0.01, scale = T, mbar = T, mse = 0.01, plotmig = T, plotnames = T, xmin = 0, lwd = 1, font = 1, pdfOut){
	pdf(pdfOut,width=8,height=8)
...
plot_tree = function(stem, pdfOut){
	o = NA
	cex = 1
	disp = 0.003
	plus = 0.01
	...
	plot_tree_internal(d, e, o = o, cex = cex, xmin = xmin, disp = disp, plus = plus, arrow = arrow, ybar = ybar, mbar = mbar, mse = m, scale = scale, plotmig = plotmig, plotnames = plotnames, lwd = lwd, font = font, pdfOut)
	return(list( d= d, e = e))
}
